...
<head>
 ...
 http-equiv="content-type">
  <title>unblock-url-net-access-module</title>
</head>
<body>
<div style="text-align: center;"><br>
<span style="font-weight: bold;">URL unblock-url-net-access module</span><br>
<br>
...
<form action="unblock.url.net.access.php" method = "post">
...
<br>
<br>
<input style="width: 25%;" name="unblock_url_net_access" value="Unblock access to NET/URL list(s)" type="submit">
<br>
</form>
</span></div>
</div>
