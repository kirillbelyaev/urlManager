...
<head>
 ...
 http-equiv="content-type">
  <title>URL-delete-module</title>
</head>
<body>
<div style="text-align: center;"><br>
<span style="font-weight: bold;">URL delete module</span><br>
<br>
...
<form action="delete.url.php" method = "post">
...
<br>
<input style="width: 50%;" name="delete_urls" value="Delete URLs" type="submit">
<br>
</form>
</span></div>
</div>
